...
public class BaiduMapActivity extends AbstractLocationMap
{
    ...
    protected void setLocation(GpsInfo gpsInfo)
    {
        ...
        try
        {
            ...
            {
                myLocationOverlay.isPop = true;
                popupText.setText(gpsInfo.getAddress());
                pop.showPopup(ImageUtil.getBitmapFromView(popupText), geoPoint, 18);
            }
            mMapView.refresh();
        } catch (Exception e)
        {
        ...
        protected boolean dispatchTap()
        {
            ...
            } else
            {
                ...
                if (!TextUtils.isEmpty(gpsInfo.getAddress()))
                {
                    isPop = true;
                    popupText.setText(gpsInfo.getAddress());
                    pop.showPopup(ImageUtil.getBitmapFromView(popupText), CoordinateConvertUtil.gcj02ToBd09(gpsInfo), 18);
                }
