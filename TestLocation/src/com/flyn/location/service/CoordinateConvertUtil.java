...
public class CoordinateConvertUtil
{
    ...
    public static com.baidu.platform.comapi.basestruct.GeoPoint gcj02ToBd09(GpsInfo gps)
    {
        ...
        com.baidu.platform.comapi.basestruct.GeoPoint geoPoint = new com.baidu.platform.comapi.basestruct.GeoPoint(
                (int) (Double.valueOf(gps.getLatitude()) * 1e6), (int) (Double.valueOf(gps.getLongitude()) * 1e6));
