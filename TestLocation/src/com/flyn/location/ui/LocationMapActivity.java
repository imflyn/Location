...
public class LocationMapActivity extends AbstractLocationMapActivity
{
    ...
    private void initGoogleMap()
    {
        ...
        {
            fl_contain.removeView(googleMapView);
            googleMapView = null;
        } else
        {
            googleMapView = new MapView(this, "AIzaSyBtBtWjXQ7UL89l8dnw4mg9ET1hka3Wj94");
            L.i("addMapView:" + this.hashCode());
    ...
    {
        googlePoint = new GeoPoint((int) (Double.valueOf(gpsInfo.getLatitude()) * 1E6), (int) (Double.valueOf(gpsInfo.getLongitude()) * 1E6));
    ...
    {
        MapView.LayoutParams params = new MapView.LayoutParams(MapView.LayoutParams.WRAP_CONTENT, MapView.LayoutParams.WRAP_CONTENT, googlePoint, MapView.LayoutParams.BOTTOM_CENTER);
        if (null != googleMapView)
        {
